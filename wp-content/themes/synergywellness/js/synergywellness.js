...
function callAnystretch() {
	...
	$('.treat_bottom_left_bg').anystretch("/wp-content/themes/synergywellness/images/treat_sugaring.jpg", {speed: 0});
	...
	$('#sugaring .page-img').anystretch("/wp-content/themes/synergywellness/images/sugaring.jpg", {speed: 0});
