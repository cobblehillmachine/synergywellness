...
function my_login_logo() { ?>
    <style type="text/css">
        body.login div#login h1 a {
            background-image: url(<?php echo get_bloginfo( 'template_directory' ) ?>/images/loading.png);
            background-size:auto; width:320px; height:130px;
        }
    </style>
<?php }
...
function create_post_type() {
	...
	$args1 = array(
		...
		'public' => true,
		//'has_archive' => true,
		'rewrite' => array('slug' => 'home-slides'),
		'supports' => array( 'title', 'thumbnail' )
	);
  
  	register_post_type( 'Home Slides', $args1);
